...
const STRIPS = [
  ...
  { file: 'engineer__player__walk', base: 'engineer__player__move', state: 'walk' },
  { file: 'commando__player__walk', base: 'commando__player__move', state: 'walk' },
  { file: 'laser_trooper__player__walk', base: 'laser_trooper__player__move', state: 'walk' },
  { file: 'razor__player__walk', base: 'razor__player__move', state: 'walk' },
  ...
  { file: 'medium_tank__player__drive', base: 'medium_tank__player__move', state: 'drive', treads: [[160, 190, 42, 180], [318, 190, 42, 180]] },
  { file: 'super_heavy_tank__player__drive', base: 'super_heavy_tank__player__move', state: 'drive', treads: [[130, 150, 52, 230], [330, 150, 52, 230]] },
  { file: 'howitzer__player__drive', base: 'howitzer__player__move', state: 'drive', treads: [[158, 200, 42, 170], [316, 200, 42, 170]] },
  { file: 'tempest__player__drive', base: 'tempest__player__move', state: 'drive', treads: [[150, 170, 46, 200], [320, 170, 46, 200]] },
  { file: 'transport_apc__player__drive', base: 'transport_apc__player__move', state: 'drive', treads: [] },
  { file: 'repair_truck__player__drive', base: 'repair_truck__player__move', state: 'drive', treads: [] },
  ...
  { file: 'howitzer__player__fire', base: 'howitzer__player__move', state: 'fire', muzzle: [256, 150, 36] },
  { file: 'medium_tank__player__fire', base: 'medium_tank__player__move', state: 'fire', muzzle: [256, 120, 30] },
  { file: 'super_heavy_tank__player__fire', base: 'super_heavy_tank__player__move', state: 'fire', muzzle: [256, 110, 40] },
  { file: 'laser_trooper__player__fire', base: 'laser_trooper__player__move', state: 'fire', muzzle: [256, 116, 22] },
  { file: 'razor__player__fire', base: 'razor__player__move', state: 'fire', muzzle: [256, 120, 24] },
];
