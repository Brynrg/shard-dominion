...
`public/art/` is generated for this project from original prompts/code; **no third-party artwork, sound, or font files are included.**
...
| `public/art/presentation/*.png` | Title backdrop, Act I–IV cards, credits backdrop, six character portraits | Replaced 2026-09-22 using OpenAI image generation: title and credits backdrops, four act illustrations, and six character portraits. The older code-drawn generator remains historical tooling. | AI-generated for this project from original game art direction; used under the applicable OpenAI output terms. |
...
| Fonts | UI text | System monospace and sans-serif stacks; no bundled font files. | n/a. |
...
Grok-generated painted sprites. Terrain remains code-drawn. Presentation art was replaced with OpenAI-generated illustrations on 2026-09-22. Earlier
